...
Sou um desenvolvedor focado em backend, construindo APIs REST e aplicações voltadas para soluções reais.

Atualmente estudo arquitetura backend, integração com banco de dados e aplicações com IA, buscando evoluir constantemente na construção de sistemas organizados, escaláveis e bem estruturados.

Tenho experiência prática com projetos próprios, incluindo assistentes inteligentes, aplicações web e sistemas backend utilizando Node.js, Express e bancos de dados relacionais e não relacionais.
...
<p align="left">
  <a href=["https://www.linkedin.com/in/h%C3%A9lio-levi-morias-vieira-472918347/" target="_blank"](https://skillicons.dev/icons?i=linkdin&theme=dark)](https://skillicons.dev))>
